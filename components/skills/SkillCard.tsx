    ...
    return (
        <div className="flex flex-col justify-center items-center gap-2">
            <div title={name} style={{ backgroundColor: bgColor }}
                ...
                <Image alt="skill" width={100} height={100} className={`h-12 w-12 md:h-14 md:w-14 object-contain ${(name === "GitHub" || name === "Vercel" || name === "Next.js" || name === "Express.js") ? 'dark:invert' : ''}`} src={image} />
            </div>
