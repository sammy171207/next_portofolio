    ...
    return (
        <div className="w-full bg-violet-600">
            <div className="xl:max-w-6xl mx-auto md:mx-6 lg:mx-10 xl:mx-auto py-16 md:py-24 text-center text-white">
                ...
                <Link href={'https://github.com/saviomartin/nextjs-portfolio'} target="_blank" className="mt-8 bg-white text-violet-600 px-6 py-3 rounded-md font-semibold text-lg inline-flex items-center gap-2"> <FaGithub /> See on GitHub</Link>
            </div>
        </div>
    )
}
